...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1796010619;
...
abstract class RustLibApi extends BaseApi {
  Config crateApiConfigConfigEmpty();

  Config crateApiConfigConfigNew({required String value});

  String crateApiConfigConfigToString({required Config that});
  ...
  Future<Release> crateApiUpdateUpdateFetch();

  Stream<Uint8List> crateApiUpdateAssetDownload({required Asset that});

  Asset? crateApiUpdateReleaseAssetOf(
      {required Release that, required Platform platform});

  bool crateApiUpdateReleaseCheckUpdate(
      {required Release that, required String version});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Config crateApiConfigConfigEmpty() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiConfigConfigEmptyConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiConfigConfigEmptyConstMeta => const TaskConstMeta(
        debugName: "config_empty",
        argNames: [],
      );
  ...
  Config crateApiConfigConfigNew({required String value}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiConfigConfigNewConstMeta,
      argValues: [value],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiConfigConfigNewConstMeta => const TaskConstMeta(
  ...
  String crateApiConfigConfigToString({required Config that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiConfigConfigToStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiConfigConfigToStringConstMeta =>
      const TaskConstMeta(
        debugName: "config_to_string",
        argNames: ["that"],
      );
  ...
  Future<Release> crateApiUpdateUpdateFetch() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiUpdateUpdateFetchConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUpdateUpdateFetchConstMeta => const TaskConstMeta(
        debugName: "Update_fetch",
        argNames: [],
      );
  ...
  Stream<Uint8List> crateApiUpdateAssetDownload({required Asset that}) {
    ...
    unawaited(handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_asset(that, serializer);
      ...
      constMeta: kCrateApiUpdateAssetDownloadConstMeta,
  ...
  TaskConstMeta get kCrateApiUpdateAssetDownloadConstMeta =>
      const TaskConstMeta(
        debugName: "asset_download",
  ...
  Asset? crateApiUpdateReleaseAssetOf(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_release(that, serializer);
        sse_encode_platform(platform, serializer);
        return pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 44)!;
      },
      codec: SseCodec(
        decodeSuccessData: sse_decode_opt_box_autoadd_asset,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiUpdateReleaseAssetOfConstMeta,
      argValues: [that, platform],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUpdateReleaseAssetOfConstMeta =>
      const TaskConstMeta(
        debugName: "release_asset_of",
  ...
  bool crateApiUpdateReleaseCheckUpdate(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiUpdateReleaseCheckUpdateConstMeta,
      argValues: [that, version],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUpdateReleaseCheckUpdateConstMeta =>
      const TaskConstMeta(
        debugName: "release_check_update",
  ...
  Asset? dco_decode_opt_box_autoadd_asset(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_asset(raw);
  }
  ...
  Release dco_decode_release(dynamic raw) {
    ...
    return Release(
      ...
      published: dco_decode_String(arr[1]),
      prerelease: dco_decode_bool(arr[2]),
      assets: dco_decode_list_asset(arr[3]),
    );
  }
  ...
  Asset sse_decode_asset(SseDeserializer deserializer) {
    ...
    return Asset(name: var_name, size: var_size, url: var_url);
  }
  ...
  Asset sse_decode_box_autoadd_asset(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_asset(deserializer));
  }
  ...
  Asset? sse_decode_opt_box_autoadd_asset(SseDeserializer deserializer) {
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_asset(deserializer));
    } else {
      return null;
    }
  }
  ...
  void sse_encode_box_autoadd_asset(Asset self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_asset(self, serializer);
  }
  ...
  void sse_encode_opt_box_autoadd_asset(Asset? self, SseSerializer serializer) {
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_asset(self, serializer);
    }
  }
